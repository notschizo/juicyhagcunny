...
API v2 has a rate limit of 600 requests per minute (10 requests per second) per IP address. If you need more, it might be worth [self-hosting](/deployment/) your own instance.
