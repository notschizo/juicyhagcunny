...
You can specify between 2 and 4 image IDs. The image IDs for Twitter correspond to the filename of the iamge on the pbs.twimg.com url. On Bluesky, it's the full DID of the image.
